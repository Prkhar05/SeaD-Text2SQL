...
def get_or_build_tokenizer(config, ds):
    ...
    if not Path.exists(tokenizer_path):
        ...
        tokenizer.train_from_iterator(get_all_text(ds), trainer=trainer)
...
def get_model(config, vocab_src_len, vocab_tgt_len):
    model = build_model(src_vocab_size=vocab_src_len, tgt_vocab_size=vocab_tgt_len,d_model=config['d_model'],)
    return model
