...
class TextToSQLDataset(Dataset):
    ...
    def process_data(self, question, schema, sql):
        ...
        src_encoding = self.tokenizer.encode_plus(src, padding='max_length', truncation=True, max_length=self.max_length, return_tensors='pt')
        tgt_encoding = self.tokenizer.encode_plus(tgt, padding='max_length', truncation=True, max_length=self.max_length, return_tensors='pt')
